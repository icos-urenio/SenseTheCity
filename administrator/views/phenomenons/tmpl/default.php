...
<form action="<?php echo JRoute::_('index.php?option=com_sensethecity&view=phenomenons'); ?>" method="post" name="adminForm" id="adminForm">
		...
		<thead>
			<tr>
                ...
                <th width="24%" class="nowrap">
                    <?php echo JHtml::_('grid.sort',  'COM_SENSETHECITY_SENSETHECITY_HEADING_NAME', 'a.name', $listDirn, $listOrder); ?>
                </th>
                <?php } ?>
                ...
                <th width="50%" class="nowrap">
                    <?php echo JHtml::_('grid.sort',  'COM_SENSETHECITY_SENSETHECITY_HEADING_DESCRIPTION', 'a.description', $listDirn, $listOrder); ?>
                </th>
                <?php } ?>					
                <?php if (isset($this->items[0]->unit)) { ?>
                ...
                <?php if (isset($this->items[0]->ordering)) { ?>
				    <td class="order">
					    <?php if ($canChange) : ?>
						    <?php if ($saveOrder) :?>
							    <?php if ($listDirn == 'asc') : ?>
								    <span><?php echo $this->pagination->orderUpIcon($i, true, 'phenomenons.orderup', 'JLIB_HTML_MOVE_UP', $ordering); ?></span>
								    <span><?php echo $this->pagination->orderDownIcon($i, $this->pagination->total, true, 'phenomenons.orderdown', 'JLIB_HTML_MOVE_DOWN', $ordering); ?></span>
							    <?php elseif ($listDirn == 'desc') : ?>
								    <span><?php echo $this->pagination->orderUpIcon($i, true, 'phenomenons.orderdown', 'JLIB_HTML_MOVE_UP', $ordering); ?></span>
								    <span><?php echo $this->pagination->orderDownIcon($i, $this->pagination->total, true, 'phenomenons.orderup', 'JLIB_HTML_MOVE_DOWN', $ordering); ?></span>
							    <?php endif; ?>
						    <?php endif; ?>
